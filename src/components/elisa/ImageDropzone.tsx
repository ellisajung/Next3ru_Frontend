...
const variants = {
  base: "relative rounded-md w-full flex justify-center items-center flex-col cursor-pointer min-h-[150px] min-w-[200px] border border-dashed border-gray-400 dark:border-gray-300 transition-colors duration-200 ease-in-out",
  image:
    "w-full sm:w-1/2 lg:w-1/3 xl:w-1/4 border-0 p-1 h-full relative shadow-md rounded-md",
  active: "border-2",
  disabled:
...
const MultiImageDropzone = React.forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    return (
      <div className="mt-1 ">
        <div className="flex flex-wrap border border-slate-200 rounded-md">
          {/* Images */}
            ...
            >
              ...
              <div className="flex flex-col items-center justify-center text-xs text-gray-400">
                ...
                <div className="text-gray-400">
                  드래그앤드랍 또는 클릭하여 파일을 업로드하세요.
                </div>
                <div className="mt-3">
                  <Button disabled={disabled}>파일 첨부</Button>
                </div>
              </div>
            </div>
          )}
