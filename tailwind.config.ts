...
const config = {
  ...
  theme: {
  	...
  	extend: {
  		...
  		backgroundImage: {
  			'custom-gradient': 'linear-gradient(45deg,#000000,#1C1C1C, #2E2E2E, #151515,#000000,#000000,#000000,#EC1C23)',
  			'card-gradient': 'linear-gradient(157deg, #ffffff ,#ffffff, #ffffff,#000 ,#000000 ,#000000 )',
